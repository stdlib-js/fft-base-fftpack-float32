...
import decompose = require( '@stdlib/fft-base-fftpack-float32-decompose' );
import rfftf = require( '@stdlib/fft-base-fftpack-float32-rfftf' );
import rffti = require( '@stdlib/fft-base-fftpack-float32-rffti' );
...
interface Namespace {
	...
	*
	* var initial = new Uint32Array( [ 3, 4, 2, 5 ] );
